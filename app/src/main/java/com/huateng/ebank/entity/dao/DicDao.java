 ...
 * DAO for table "Dic".
*/
public class DicDao extends AbstractDao<Dic, Long> {
    ...
    @Override
    protected final void attachEntity(Dic entity) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Dic entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Dic entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
