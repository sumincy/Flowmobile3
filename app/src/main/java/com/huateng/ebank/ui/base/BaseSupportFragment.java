...
/**
 * Created by shanyong on 2019/4/2.
 */

public abstract class BaseSupportFragment<V extends ViewDataBinding, VM extends BaseViewModel> extends BaseFragment<V, VM> implements ISupportFragment {
    ...
    public static BaseSupportFragment newInstance(Class<?> clazz) {
        Bundle args = new Bundle();
        BaseSupportFragment fragment = null;
        try {
            fragment = (BaseSupportFragment) clazz.newInstance();
    ...
    public static BaseSupportFragment newInstance(Class<?> clazz, Bundle args) {
        BaseSupportFragment fragment = null;
        try {
            fragment = (BaseSupportFragment) clazz.newInstance();
            fragment.setArguments(args);
    ...
    //沉浸状态栏
    protected void immersiveStatusBar(View view) {
        SystemBarHelper.immersiveStatusBar(getActivity(), 0);
        SystemBarHelper.setHeightAndPadding(getActivity(), view);
    }
}
