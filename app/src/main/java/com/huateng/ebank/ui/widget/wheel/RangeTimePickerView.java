...
public class RangeTimePickerView extends BasePickerView {

    public wheelRangeTime wheelTime; //自定义控件
    private RangePickerOptions cPickerOptions;

    public RangeTimePickerView(RangePickerOptions pickerOptions) {
        super(pickerOptions.context);
        mPickerOptions = pickerOptions;
        cPickerOptions = pickerOptions;
    ...
    private void initWheelTime(LinearLayout timePickerView) {
        wheelTime = new wheelRangeTime(timePickerView, mPickerOptions.type, mPickerOptions.textGravity, mPickerOptions.textSizeContent);
        if (cPickerOptions.rangeTimeSelectChangeListener != null) {
            wheelTime.setSelectChangeCallback(new ISelectTimeCallback() {
                @Override
                public void onTimeSelectChanged() {
                    cPickerOptions.rangeTimeSelectChangeListener.onRangeTimeSelectChanged(wheelTime.getTime());
                }
            });
        }
    ...
    public void returnData() {
        if (cPickerOptions.rangeTimeSelectListener != null) {
            cPickerOptions.rangeTimeSelectListener.onTimeSelect(wheelTime.getTime(), clickView);
        }
    }
