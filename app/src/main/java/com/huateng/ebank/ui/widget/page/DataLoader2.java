...
public abstract class DataLoader2<T> implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public DataLoader2(Context context, RecyclerView recyclerView, BaseQuickAdapter baseQuickAdapter, SwipeRefreshLayout swipeRefreshLayout) {
    ...
    //获取数据处理
    public void handler(int mode, List<T> datas) {
