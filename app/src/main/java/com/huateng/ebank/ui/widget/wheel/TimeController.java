...
public class TimeController {
    ...
    public TimeController(WheelView wv_year, WheelView wv_month, WheelView wv_day, WheelView wv_hours, WheelView wv_minutes, WheelView wv_seconds) {
        this.wv_year = wv_year;
        this.wv_month = wv_month;
        this.wv_day = wv_day;
        this.wv_hours = wv_hours;
        this.wv_minutes = wv_minutes;
        this.wv_seconds = wv_seconds;
    }

    public void init(View view, int year, final int month, int day, int h, int m, int s) {
        this.view = view;
        ...
        if (currentYear == startYear) {
           /* int i = wv_start_month.getCurrentItem() + startMonth;
            ...
            if ((wv_month.getCurrentItem() + startMonth) == startMonth) {
                calendar.set(wv_year.getCurrentItem() + startYear, wv_month.getCurrentItem() + startMonth, wv_day.getCurrentItem() + startDay, wv_hours.getCurrentItem(), wv_minutes.getCurrentItem(), wv_seconds.getCurrentItem());
            } else {
                calendar.set(wv_year.getCurrentItem() + startYear, wv_month.getCurrentItem() + startMonth, wv_day.getCurrentItem() + 1, wv_hours.getCurrentItem(), wv_minutes.getCurrentItem(), wv_seconds.getCurrentItem());
            }
        } else {
            calendar.set(wv_year.getCurrentItem() + startYear, wv_month.getCurrentItem(), wv_day.getCurrentItem() + 1, wv_hours.getCurrentItem(), wv_minutes.getCurrentItem(), wv_seconds.getCurrentItem());
        }
