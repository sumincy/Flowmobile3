...
/**
 * Created by shanyong on 2019/10/25.
 */
public class CustomCommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private int mSelectedSectionResId;
    /**
     * 用于绘制显示器
     */
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if(isSelect){
                tabView.setBackgroundResource(mSelectedSectionResId);
            }else{
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setSelectedSectionResId(int mSelectedSectionResId) {
        this.mSelectedSectionResId = mSelectedSectionResId;
    }
    ...
    class PointEvaluator implements TypeEvaluator<CustomCommonTabLayout.IndicatorPoint> {
        @Override
